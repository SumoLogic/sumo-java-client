...
3. Make a release branch with Scala version and project version, ex. `sumo-java-client-2.11`:
    ```
    export RELEASE_VERSION=sumo-java-client-2.11
...
6. Update the `README.md` and `CHANGELOG.md` with the new version and set upcoming snapshot `version`
   in `build.gradle`, ex. `2.12-SNAPSHOT`
